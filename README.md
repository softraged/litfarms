...
![LitFarms Product Listing Interface](https://i.imgur.com/N9rQuN1.jpeg)
...
This section details some of the significant updates introduced in this fork.
...
- **Theme Editor:** Added to allow users to customize the interface theme.
...
- **Programmatic Weight Filtering:** Weight filtering is now dynamic, automatically listing all available weights rather than being fixed (replaces the hardcoded filters).

### Notification System
- **New In-Browser Notifications:** A simple notification system has been added to the interface. New products, product changes, and out of stock events can appear in this system.
---
...
- Multiple notification methods:
  ...
  * Email notifications
  * (New, WIP) In-browser notifications
...
### Basic Usage
    1. Visit the website at https://softraged.github.io/litfarms/
